                ...
                <div className='aboutMe__container-profile'>
                    <div className='aboutMe__profile'>
                        ...
                        <ul className='aboutMe__social-list'>
                            <li><a className='aboutMe__social-link' href='#'>ВКонтакте</a></li>
                            <li><a className='aboutMe__social-link' href='#'>Gihub</a></li>
                        </ul>
                    </div>
                ...
                <div className='aboutMe__container-portfolio'>
                    ...
                    <ul className='aboutMe__portfolio-list'>
                        <li className='aboutMe__portfolio-item'>
                            <a className='aboutMe__portfolio-link' href='#'>Статичный сайт</a>
                        ...
                        <li className='aboutMe__portfolio-item'>
                            <a className='aboutMe__portfolio-link' href='#'>Адаптивный сайт</a>
                            <a className='aboutMe__portfolio-link' href='#'>
                                <img className='aboutMe__portfolio-arrow' src={Arrow} alt="Стрелка"/>
                            </a>
                        </li>
                        <div className='aboutMe__portfolio-border'></div>
                        <li className='aboutMe__portfolio-item'>
                            <a className='aboutMe__portfolio-link' href='#'>Одностраничное приложение</a>
                            <a className='aboutMe__portfolio-link' href='#'>
                                <img className='aboutMe__portfolio-arrow' src={Arrow} alt="Стрелка"/>
                            </a>
                        </li>
